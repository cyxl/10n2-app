...
#define TF_BAD_J_LEN 2
  static struct aud_req tf_bad_j[TF_BAD_J_LEN] = {
      {1, DEF_VOLUME, 200, 120}, {0, 255, 0, 0}, // off
  };
...
#define TF_NONE_J_LEN 6
  static struct aud_req tf_none_j[TF_NONE_J_LEN] = {
      {1, DEF_VOLUME, 200, 20}, {0, 255, 0, 0}, // off
      {1, DEF_VOLUME, 200, 20}, {0, 255, 0, 0}, // off
      {1, DEF_VOLUME, 200, 20}, {0, 255, 0, 0}, // off
  };
